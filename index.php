...
<body class="<?php echo $active->alias . ' page-' . str_replace('com_', '', $option) . ' view-' . $view . ' task-' . ($task ? $task : 'none') . ($pageclass ? ' ' . $pageclass : '') . ' itemid-' . $active->id; ?>">
    ...
    <header id="<?php echo $this->template; ?>-header" class="<?php echo $this->template; ?>-header header">
        ...
        <div class="container">
            <div class="row">
                <?php if (!empty($logo)) {?>
                <div id="<?php echo $this->template; ?>-logo" class="<?php echo $this->template; ?>-logo <?php echo $defaultmode == 'bootstrap' ? $default_column . '2 col-6' : ''; ?>" <?php echo $defaultmode == 'custom' ? ' width="16.66%"' : ''; ?>>
                    <h1>
                ...
                <div id="button-canvas" class="<?php echo $this->template; ?>-navigation-button col d-block d-lg-none">
                    <button id="offcanvas_button" style="float:right;" class="btn button offCanvas_trigger float-right ml-auto">
                        <i class="fa fa-bars"></i>
                    </button>
                </div>
                <nav id="<?php echo $this->template; ?>-navigation" class="<?php echo $this->template; ?>-navigation navbar navbar-expand-lg col d-lg-block d-none">
