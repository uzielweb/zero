...
<<?php echo $moduleTag; ?>
    class="moduletable <?php echo $module->name." ".$module->name."-".$module->id." ".$module->name."-".$module->position.htmlspecialchars($params->get('moduleclass_sfx'), ENT_COMPAT, 'UTF-8') . $moduleClass; ?>"
    <?php echo $col_module_width?>>
    <?php if ((bool) $module->showtitle) :?>
    <<?php echo $headerTag . $headerClass . '>' . $module->title; ?> </<?php echo $headerTag; ?>> <?php endif; ?>
        <?php echo $module->content; ?> </<?php echo $moduleTag; ?>> <?php endif;
}
/*
...
$headerClass    = $params->get('header_class');
$headerClass    = !empty($headerClass) ? ' class="module-title ' . htmlspecialchars($headerClass, ENT_COMPAT, 'UTF-8') . '"' : ' class="module-title"';
if (!empty ($module->content)) : ?> <<?php echo $moduleTag; ?>
        class="moduletable <?php echo " module-".$module->name." ".$module->name."-".$module->id." ".$module->name."-".$module->position.htmlspecialchars($params->get('moduleclass_sfx'), ENT_COMPAT, 'UTF-8') . $moduleClass; ?>"
        <?php echo $col_module_width?>>
        <?php if ((bool) $module->showtitle) :?>
        <<?php echo $headerTag . $headerClass . '>' . $module->title; ?> </<?php echo $headerTag; ?>> <?php endif; ?>
            <?php echo $module->content; ?> </<?php echo $moduleTag; ?>> <?php endif;
...
?> <table cellpadding="0" cellspacing="0"
            class="moduletable <?php echo " module-".$module->name." ".$module->name."-".$module->id." ".$module->name."-".$module->position.htmlspecialchars($params->get('moduleclass_sfx'), ENT_COMPAT, 'UTF-8'); ?><?php echo $moduleClass;?>"
            <?php echo $col_module_width; ?>>
            <?php if ((bool) $module->showtitle) : ?>
            <tr>
                <th>
...
if (!empty ($module->content)) :
?> <div class="module <?php echo " module-".$module->name." ".$module->name."-".$module->id." ".$module->name."-".$module->position.htmlspecialchars($params->get('moduleclass_sfx'), ENT_COMPAT, 'UTF-8') . $moduleClass; ?>"
                    <?php echo $col_module_width; ?>>
                    <div>
                        <div>
                            <div>
